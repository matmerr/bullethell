    ...
    class InwardCircleFiringPattern : AbstractFiringPattern
    {
        ...
        public override AbstractFiringPattern Exec()
        {
            ...
            while (i < 360){
                ...
                MainContent.Events.AddScheduledTaggedEvent(middle, middle+1, tag, () => bullet.DecrementOrbitRadius());
                MainContent.Events.AddScheduledTaggedEvent(middle+1,stop, tag, () => bullet.IncrementOrbitRadius());
                MainContent.Events.AddSingleTaggedEvent(start, fromModel, () => invis1.SetLocationFromSourcetModel());
